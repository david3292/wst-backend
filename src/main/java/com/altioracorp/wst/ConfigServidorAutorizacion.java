...
public class ConfigServidorAutorizacion extends AuthorizationServerConfigurerAdapter {
	 ...
	 * Tiempo de vida del token accessTokenValiditySeconds(30) 30 segundos.
	 * TODO: Definir el tiempo de sesión del tocken
	 * */
	@Override
	public void configure(ClientDetailsServiceConfigurer configurer) throws Exception {
		...
		.scopes(scopeRead, scopeWrite).resourceIds(resourceIds).accessTokenValiditySeconds(28800) //8 horas
